...
The first evident difference between the two methods is that \citetalias{Verma.Raodeo.ea2019} found several extreme solutions for \(\delta\nu\) whereas GP did not. We expected this because the GP method used a prior on the model parameters.

Secondly, we found a smaller amplitude \(\delta\nu\) at low frequency with the GP method than with the \citetalias{Verma.Raodeo.ea2019} method. We found that this was a result of the different smooth background models.
