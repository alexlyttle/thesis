...
\todo{Signature of helium first explored by}.

\todo{Some key results from glitch studies}.
...
\citetalias{Verma.Raodeo.ea2019} method. Additionally, the GP was able to model the small glitch signal due to He\,\textsc{i} ionisation. This raises the question of whether He\,\textsc{i} ionisation glitch should be included in the model --- this depends how much helium abundance is to be gained from its parameters.
