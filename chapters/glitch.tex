...
%
\begin{equation}
    \left.\frac{\delta\omega}{\omega}\right|_\mathrm{osc} \approx - \frac{1}{2T_0} \int \frac{\delta\gamma}{\gamma} \cos 2 (\omega\tau + \epsilon) \, \dd \tau,
\end{equation}
%
...
Combine the above two equations and changing variables to \(t = \tau - \tau_\heII\), we get,
%
\begin{equation}
    \left.\frac{\delta\omega}{\omega}\right|_{\heII, \mathrm{osc}} \approx \frac{\Gamma_\heII}{2\sqrt{2\pi}\,\Delta_\heII T_0} \, \int_{-\infty}^\infty e^{- {t^2}/{2 \Delta_\heII^2} } \cos 2 (\omega t + \tilde{\epsilon}) \, \dd t
\end{equation}
%
where \(\tilde{\epsilon} = \omega\tau_\heII + \epsilon_\heII\) and the phase \(\epsilon=\epsilon_\heII\) is assumed constant accross the glitch region. We can solve the above integral analytically using differentiation under the integral sign by introducing an arbitrary variable \(a\),
%
\begin{equation}
    I(a) = \int_{-\infty}^\infty e^{- {t^2}/{2 \Delta_\heII^2} } \cos 2 (a \omega t + \tilde{\epsilon}) \, \dd t
\end{equation}
%
Differentiating this with respect to \(a\), and then integrating by parts gets,
%
\begin{align}
    I'(a) &= - 2 \omega \int_{-\infty}^\infty t \, e^{- {t^2}/{2\Delta_\heII^2} } \sin 2 (a \omega t + \tilde{\epsilon}) \, \dd t, \notag\\
    &= - 2 \omega \Delta_\heII^2 \int_{-\infty}^\infty \sin 2 (a \omega t + \tilde{\epsilon}) \, \dd s, \qquad \mathrm{where} \ s = - \frac12 {\Delta_\heII^{-2}}\,t \, e^{- {t^2}/{2\Delta_\heII^2} }, \notag\\
    &= 2\omega\Delta_\heII^2 \left\{ \left[ e^{- {t^2}/{2\Delta_\heII^2} } \sin 2 (a \omega t + \tilde{\epsilon}) \right]_{-\infty}^\infty - 2a\omega \int_{-\infty}^\infty e^{- {t^2}/{2 \Delta_\heII^2} } \cos 2 (a \omega t + \tilde{\epsilon}) \, \dd t \right\}, \notag\\
    &= - 4 a \omega^2 \Delta_\heII^2 \, I(a),
\end{align}
%
...
\begin{equation}
    \begin{split}
        I(a) = I(0) e^{- 2 \Delta_\heII^2 \omega^2 a^2}, \qquad I(0) &= \int_{-\infty}^\infty e^{- {t^2}/{2 \Delta_\heII^2} } \cos 2 \tilde{\epsilon} \, \dd t, \\
        &= \sqrt{2\pi} \, \Delta_\heII \cos 2 \tilde{\epsilon},
    \end{split}
\end{equation}
%
Therefore, if we set \(a = 1\) to match Equation \ref{} we get the following for the oscillatory glitch signature \citep[cf.][]{Houdek.Gough2007},
%
\begin{equation}
    \left.\frac{\delta\omega}{\omega}\right|_{\heII, \mathrm{osc}} \approx \frac{\Gamma_\heII}{2 T_0} e^{- 2 \Delta_\heII^2 \omega^2} \cos 2 (\omega \tau_\heII + \epsilon_\heII),
\end{equation}
%
