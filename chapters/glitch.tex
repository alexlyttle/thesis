...
This was caused by the difference in smooth background models, with the GP appearing to be more flexible than the polynomial. In future work, we could test the accuracy of the GP background by making predictions for lower \(n\) modes and seeing which method does better.

The large lower uncertainty from the GP method result could arise from our method picking up the small signal due to He\,\textsc{i} ionisation.
