...
%
\begin{equation}
    f(n, l) = \tilde{\nu}_{nl} + \delta(\tilde{\nu}_{nl}) \label{eq:general-glitch}
\end{equation}
%
...
\end{gather*}
%
% This satisfies the consistency requirement that 
