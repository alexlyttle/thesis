...
\section[Stellar properties]{Inferring physical properties of stars}

\todo{We have seen a simple example of an HBM on distances to stars. In this thesis, we are interested in determining the physical properties of stars, such as their mass, radius and age.}
