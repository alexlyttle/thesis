...
Modelling stars the Bayesian way involves estimating the probability of stellar parameters (e.g. \(\theta = \text{mass, age}, \dots\)) given observations (\(y\)). We can do this starting with Bayes' theorem for the \emph{posterior} probability density,
%
\begin{equation}
