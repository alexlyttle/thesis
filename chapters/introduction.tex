...
Since the late 19th century, astronomers have been trying to understand the physical structure and evolution of the Sun and other stars. They wanted to understand whether other stars were like the Sun and whether they changed with time. Answers to these questions could tell us where we came from and what the future holds for the solar system. While little was known of this at the time, researchers started by gathering data in an effort to map the night sky. The invention of the spectrograph by \citet{Draper1874} allowed astronomers to systematically classify stars by their brightness in different wavelengths of light \citep{Maury.Pickering1897}. This was an pivotal early step towards the large-scale stellar surveys we know of today.
...
Insight into stellar evolution came about when astronomers ordered open clusters on the HR diagram \needcite. Assuming open clusters formed at the same time with similar chemical abundances, the only expected difference between stars were their mass and multiplicity. By plotting systems of known mass (e.g. from orbital solutions to binary star systems), \citet{Kuiper1938} found an empirical mass-luminosity relation. Astronomers joined open clusters with lines of similar mass and began to postulate the evolutionary trajectory of a star \needcite. Deriving the stellar radius (\(R\)) from the relation \(L \propto R^2 \teff^4\), astronomers inferred that stars got bigger as they evolved. Starting on the main sequence, stars would get brighter and larger before rapidly cooling and ascending the red giant branch.
...
In the second half of the 20th century, the theory of stellar evolution advanced. With this came computational methods for modelling stars \citep{Kippenhahn.Weigert.ea1967}. Astronomers could start to compare observations and empirical relations for fundamental parameters with simulated stars. On a similar timescale, a new field called asteroseismology emerged to help further constrain stellar models. Asteroseismology allowed astronomers to effectively look inside stars. While the field spans a wide range of oscillating stars, we choose to focus on stars which oscillate like the Sun. In Section \ref{sec:seismo} we give a brief history and theory of these solar-like oscillators.

Today, astronomers have a huge abundance of data to test the theory of stellar evolution and determine stellar parameters. Large-scale surveys have lead to so-called ensemble asteroseismology.  Powerful tool in Section \ref{sec:many-stars}.
